...
\section{Pierwsze oznaczenia wartości gradientu/stopnia geotermicznego\\ dla ziem polskich}

Pierwsze pomiary parametrów geotermicznych na terenach polskich wykonywane były w związku z działalnością górniczą. Pionierskie prace na tym polu podejmowano w początkach XX w. --- na Śląsku (badacze niemieccy, np. \cite{Michael.1910}) i na Podkarpaciu (ośrodek lwowski). 
	
\subsubsection{Prace Arctowskiego i in. (lata 20. XX w.)}

W latach 20. XX w. H. Arctowski, profesor Uniwersytetu Jana Kazimierza we Lwowie, koordynował prace badawcze z zakresu geotermii na ok. 150 otworach wiertniczych ropy naftowej na Podkarpaciu \parencite{Maj.2010}. Wyniki owych pomiarów, jak i opisy procedury pomiarowej były wielokrotnie publikowane \parencite{Arctowski.1924,Arctowski.1923b,Arctowski.1923a}. Badacz ten samodzielnie opracował technikę pomiaru temperatur w otworach, eksperymentował z wykorzystaniem różnych termometrów, w tym termometrów medycznych. Arctowski rozważał możliwe czynniki zakłócające pomiar, takie jak: temperatura na powierzchni, wpływ cyrkulacji wód podziemnych itp. S. Zych i J. Moniak, należący do współpracowników H. Arctowskiego, również prowadzili w końcu lat 20. prace geotermiczne, m. in. przy poszukiwaniu gorących solanek w Ciechocinku \parencite{Maj.2010}.
...
Notatka z referatu wygłoszonego w 1947 r. zawiera skrótowy opis poglądów Różyckiego na charakterystykę geotermiczną powierzchni kraju. Różycki wskazuje na dużą zmienność wielkości geotermicznych na terenie Polski. Jednocześniej zwraca uwagę na skąpy stan i niepewną wiarygodność dotychczasowych badań dla obszaru Polski (wzmiankowane badania Arctowskiego i jego uczniów; \ct{cite{bibid}}), pozwalający jedynie na wstępną i szkicową syntezę zebranych danych. Autor wyróżnia kilka regionów geotermicznych górnej litosfery w Polsce, zwracając uwagę na ich historię tektoniczną:
 \begin{itemize}[nolistsep]
 ...
 \end{itemize}
Ponadto, Różycki zwraca uwagę na odzwierciedlenie przebiegu strefy Teisseyre'a--Tornquista w rozmieszczeniu izolinii średniego stopnia geotermicznego na obszarze Polski, wskazując na róznice wieku obszarów leżących po obu stronach tej granicy tektonicznej.
...
Praca Plewy z 1966 r. zawiera opracowanie danych geotermicznych (strumienia cieplnego i gradientu geotermicznego) dla 15 \ct{??} pomiarów otworowych z Polski. Publikowane pomiary były zbierane od 1953 r.; autor wykonywał również w ramach swoich wcześniejszych prac oznaczenia stopnia geotermicznego i strumienia cieplnego w wybranych miejscach Polski oraz badania własności termicznych skał \ct{parencite{Plewa.1961,Plewa.1963a,Plewa.1963b,Plewa.1965}}. W publikacji przedstawiono wartości powierzchniowego strumienia cieplnego ziemi dla 6 punktów z obszaru Polski, na podstawie oznaczonych w wierceniach wartości gradientu geotermicznego i oporności cieplnej skał pobranych z rdzeni. Zamieszczono mapę rozkładu gradientu geotermicznego na obszarze Polski, opracowaną z wykorzystaniem rachunku całkowego \ct{??}. Na przestrzeni kolejnych dekad wydanych zostało wiele innych publikacji tego autora w temacie termiki litosfery Polski, bardziej zaawansowanych w stanie badań i zebranej wiedzy \ct{, m. in. parencite{Plewa.1994}}.
