...
\end{figure}
 ...
 %http://www.geolodzy.uni.wroc.pl/bazalty/index.html
  ...
  \iffalse
  Subdukcyjne zamknięcie basenu piemoncko-liguryjskiego w domenie wschodnioalpejskiej i w północnych Karpatach skutkowało kolizją austroalpejskiego klinu orogenicznego z kontynentem europejskim, czego konsekwencją było wyniesienie Masywu Czeskiego oraz inwersja bruzdy śródpolskiej \parencite{Dezes.2004}.
  \fi
...
\begin{sidewaystable}[h]
	\centering
	\caption{Wartości parametrów geotermicznych wyznaczone w pracach Arctowskiego (\citeyear{Arctowski.1923b,Arctowski.1923a}); \textit{Z} --- głębokość otworu, \textit{z} --- głębokość pomiaru, \textit{H} --- stopień geotermiczny, \textit{b.d.} --- brak danych}
	\label{my-label}
	\renewcommand\arraystretch{2} % increase spacing between rows
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{@{}ccccp{4.5cm}lllll@{}}
			\toprule
			Źródło & Miejsce & Data & Odwiert & Stan odwiertu & {Z [m]} & {\begin{tabular}{@{}p{4.5cm}@{}}Czas pozostawienia \newline termometru w otworze [h]\end{tabular}} & {z [m]} & {Temperatura [\textcelsius]} & {H [m/\textcelsius]} \\ \midrule
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}50 & \cellcolor[HTML]{EFEFEF}8,3 & \cellcolor[HTML]{EFEFEF} \\
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}200 & \cellcolor[HTML]{EFEFEF}12,1 & \cellcolor[HTML]{EFEFEF} \\
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}750 & \cellcolor[HTML]{EFEFEF}22,3 & \cellcolor[HTML]{EFEFEF} \\
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}880 & \cellcolor[HTML]{EFEFEF}25,6 & \cellcolor[HTML]{EFEFEF} \\
			& \cellcolor[HTML]{EFEFEF} & \multirow{-5}{*}{5.01.1923} & \multirow{-5}{*}{\cellcolor[HTML]{EFEFEF}Prezydent No 1.} & \multirow{-5}{*}{\cellcolor[HTML]{EFEFEF}W trakcie wiercenia} & \multirow{-5}{*}{\cellcolor[HTML]{EFEFEF}926} & \multirow{-5}{*}{\cellcolor[HTML]{EFEFEF}7} & \cellcolor[HTML]{EFEFEF}921 & \cellcolor[HTML]{EFEFEF}24,7 & \multirow{-5}{*}{\cellcolor[HTML]{EFEFEF}\begin{tabular}{p{4cm}}53,9 (750--200 m), \newline 48,0 (880--50 m), \newline 39,4 (220--50 m \newline i 880--750 m)\end{tabular}} \\
			& \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}5.01.1923 & Mougeot No 2. & 2--tyg. stójka & 772 & 19 & 50 & 7,9 & b.d. \\
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}50 & \cellcolor[HTML]{EFEFEF}7,5 & \cellcolor[HTML]{EFEFEF} \\
			& \cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF} & \cellcolor[HTML]{EFEFEF}250 & \cellcolor[HTML]{EFEFEF}11,0 & \cellcolor[HTML]{EFEFEF} \\
			\multirow{-9}{*}{Arctowski, 1923a} & \multirow{-9}{*}{\cellcolor[HTML]{EFEFEF}Bitków} & \multirow{-3}{*}{7.01.1923} & \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}Valotte No 3.} & \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}\begin{tabular}{p{4.5cm}}W trakcie wiercenia \newline (praca przerwana)\end{tabular}} & \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}407} & \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}21} & \cellcolor[HTML]{EFEFEF}350 & \cellcolor[HTML]{EFEFEF}12,8 & \multirow{-3}{*}{\cellcolor[HTML]{EFEFEF}56,6} \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 10 & 9,6 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 25 & 9,7 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 70 & 9,7 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 75 & 10,0 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 100 & 10,5 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 150 & 11,6 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 200 & 12,5 &  \\
			\cellcolor[HTML]{EFEFEF} &  & \cellcolor[HTML]{EFEFEF} &  &  &  &  & 250 & 13,6 &  \\
			\multirow{-9}{*}{\cellcolor[HTML]{EFEFEF}Arctowski, 1923b} & \multirow{-9}{*}{Borysław} & \multirow{-9}{*}{\cellcolor[HTML]{EFEFEF}17--20.04.1923} & \multirow{-9}{*}{Ratoczyn 5} & \multirow{-9}{*}{Otwór opuszczony} & \multirow{-9}{*}{b.d.} & \multirow{-9}{*}{b.d.} & 300 & 14,4 & \multirow{-9}{*}{b.d.} \\ \bottomrule
	\end{tabular}}
\end{sidewaystable}
...
Estimation of heat flow in Poland / Vadim V. Gordenko, O.V. Zavgorodnaja 	
W: Acta Geophysica Polonica. 0001-5725. 1996, nr 2, s. 173-180 
...
(1973) Publ. Inst. Geophys. Pol. Acad. Sc. (Materialy i Prace), 60, pp. 135-144. Cited 2 times.
